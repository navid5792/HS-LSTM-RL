...
parser.add_argument("--outputdir", type=str, default='savedir/msrp/msrp_random/', help="Output directory")
parser.add_argument("--criticmodelname", type=str, default='model_test_170.pickle')
...
parser.add_argument("--dpout_fc", type=float, default=0.170, help="classifier dropout")
...
#print(len(train['a1']), len(test['a1']), len(valid['a1']))
