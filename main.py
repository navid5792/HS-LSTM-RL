...
parser.add_argument("--outputdir", type=str, default='savedir/sicke/sicke0/', help="Output directory")

parser.add_argument("--criticmodelname", type=str, default='model_test61_215.pickle')
parser.add_argument("--actormodelname", type=str, default='model_actor.pickle')
parser.add_argument("--Newcriticmodelname", type=str, default='model_test61New_50')
parser.add_argument("--Newactormodelname", type=str, default='model_actor61New_50')
...
parser.add_argument("--dpout_fc", type=float, default=0.10, help="classifier dropout")
parser.add_argument("--nonlinear_fc", type=float, default=1, help="use nonlinearity in fc")
parser.add_argument("--optimizer", type=str, default="sgd,lr=0.13", help="adam or sgd,lr=0.1")
...
parser.add_argument("--actor_optimizer", type=str, default="adam,lr=0.26", help="adam or sgd,lr=0.1")
...
def evaluate_RL(epoch, typ = 0, eval_type='valid', final_eval=False):
    ...
    '''
    #torch.save(nli_net.state_dict(), os.path.join(params.outputdir, params.Newcriticmodelname + "_" + str(epoch) + ".pickle"))
    #torch.save(actorModel.state_dict(), os.path.join(params.outputdir, params.Newactormodelname + "_" + str(epoch) + ".pickle")) 
...
epoch = 1
print("Both Critic and Actor Training......")
while not stop_training and epoch <=params.n_epochs:
...
print("\nCritic Loaded")
actorModel.load_state_dict(torch.load(os.path.join(params.outputdir, params.Newactormodelname)))
print("\nActor Loaded")
